...
DynamicTransformPublisher::DynamicTransformPublisher()
  ...
  timer_ = this->create_wall_timer(
      ...
      std::bind(&DynamicTransformPublisher::timer_callback, this));
}
...
void DynamicTransformPublisher::timer_callback() {
  ...
  // TODO: populate the transform.header.frame_id and transform.child_frame_id
  // according to spec

  // TODO: populate the transform.transform.translation. fields (x, y, z)

  // TODO: construct a quaternion object and set the rotation values of the
  // quaternion

  // TODO: populate the transform.transform.rotation fields (x, y, z, w) with
  // the quaternion from last step
